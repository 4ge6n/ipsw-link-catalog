    ...
    static var mac: [Point] {
        [
            ...
            Point(symbol: "hand.raised",
                  ...
                  detail: String(localized: "Nothing. There is no account, no identifier, and no analytics or telemetry of any kind in this app. It asks for files and nothing else.")),
