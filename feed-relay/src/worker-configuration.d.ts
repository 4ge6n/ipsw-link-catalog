/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 0fb1eace51e22c67cbc57acb7695bc42)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 
interface __BaseEnv_Env {
	GITHUB_REPOSITORY: "4ge6n/ipsw-link-catalog";
	VAPID_PUBLIC_KEY: "BJYIRbL04SrBYIvumqQ-Cj9WeH8PpTvAg63X3cJt-1cCa4ZUG4NoIqn4ItkCOB9TYf9oAVJs2DVNw7CegjLAW2k";
	FEED_STATE: DurableObjectNamespace<import("./index").FeedState>;
	PUSH_SUBSCRIPTIONS: DurableObjectNamespace<import("./index").PushSubscriptions>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "FeedState" | "PushSubscriptions";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPOSITORY" | "VAPID_PUBLIC_KEY">> {}
}
